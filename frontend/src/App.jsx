...
<div className="border-t border-gray-100 px-6 py-3 bg-gray-50 rounded-b-xl">
  <div className="flex justify-end">
    <span
      ...
      onTouchEnd={() => setDeleteConfirmation(workout.id)}
      className="inline-flex items-center justify-center w-10 h-10 text-gray-400 hover:text-red-600 hover:bg-red-100 rounded-lg transition-colors cursor-pointer select-none"
      style={{
